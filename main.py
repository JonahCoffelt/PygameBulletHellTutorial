"""
All code and assets in this project is free to use. 
Full rights to use, make, and sell products made with this project are given.
...
class Game:
    ...
    def start(self) -> None:
        """
        Creates all handlers and starts the game
        """
